...
@interface CRBackgroundTaskManager()
@property (nonatomic, strong)NSMutableArray* bgTaskIdList;
@property (assign) UIBackgroundTaskIdentifier masterTaskId;
@end

@implementation CRBackgroundTaskManager

+(instancetype)sharedCRBackgroundTaskManager
{
    static CRBackgroundTaskManager* sharedBGTaskManager;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedBGTaskManager = [[CRBackgroundTaskManager alloc] init];
    });
